...
| ----------------------- | ------------------- | ------------ | ---------------------- | ------------------------------------------------------------------------------------------------------------------------------ 
| `id`                    | string  		| **Required** | **TBD**		| GUID generated by the Subscription System											
| `nobbParticipantNumber` | integer 		| **Required** | **TBD**		| Unique integer generated by the Subscription System										
...
| `efoParticipantNumber`  | array of integers 	| **Optional** | **TBD**		| Participant number(s) for company in EFO database											
| `email`                 | string  		| **Optional** | **TBD**		| 																
| `glnNumbers`            | array of strings 	| **Optional** | **TBD**		| Global Location Numbers													
...
| `website`               | string  		| **Optional** | **TBD**		| External URI to company website													
